...
const Jumbotron = () => {
  return (
    <section className="bg-teal-700 mt-12">
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
    <h1 className="mb-8 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white">
    Welcome to Mom's Planet!
    </h1>
    <p className="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48">
    A place where delicious recipes meet warm memories! Here, you'll find easy-to-follow dishes that are perfect for busy families.We believe that the best meals are shared with loved ones, and our recipes are designed to be enjoyed by everyone.</p>
